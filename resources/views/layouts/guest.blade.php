        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative overflow-hidden">
            ...
            <div class="mb-4">
                <a href="/" wire:navigate class="flex flex-col items-center group">
                    ...
                    <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary-600 to-secondary-500 mt-2">Anticerai</span>
                </a>
            </div>
            ...
            <div class="mt-8 text-center text-xs text-stone-400">
                &copy; {{ date('Y') }} Anticerai. Building stronger connections.
            </div>
        </div>
    </body>
</html>
